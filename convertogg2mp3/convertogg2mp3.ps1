Powershell.exe -WindowStyle hidden {
    ...
    # Start your script (watch-mining.exe) from its folder in the background and hidden
    Start-Process -FilePath "watch-mining.exe" -WindowStyle Hidden
    ...
    do {
        ...
        if (-not $AnkiRunning) {
            ...
            Get-Process -Name "watch-mining" -ErrorAction SilentlyContinue | ForEach-Object { Stop-Process -Id $_.Id -Force }
            break
        }
